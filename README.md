...
| `results/models_fit/` | Fitted `brms` models (`doc_raw_student.rds` for Q1, `b1.rds` SCM for Q2, `M.rds` for Q3). **Not tracked by git** (size); they are regenerated by the notebook |
